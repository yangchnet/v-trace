...
BLOCKER_TOOLS ?= goimports
CRITICAL_TOOLS ?= mockgen protoc-gen-go protoc-gen-doc protoc-gen-grpc-gateway \
 protoc-gen-go-grpc protoc-gen-openapiv2 protoc-gen-go-errors wire buf \
 ent stringer gobgen
TRIVIAL_TOOLS ?=
...
ifeq ($(origin SERVICE_LIST),undefined)
	SERVICE_LIST := iam vtrace goods trans circ algo
endif
